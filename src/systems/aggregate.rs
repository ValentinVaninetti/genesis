...
use crate::stats::{
    BondEnergy, BondObservation, ChemicalStructure, CollisionCounter, PotentialEnergy,
    StatsSnapshot, StructureStats,
};
...
impl System for StatsSystem {
    ...
    fn access(&self) -> Access {
        Access::default()
            ...
            .resource_read::<ChemicalStructure>()
    }
